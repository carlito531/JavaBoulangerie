...
<c:set var="list_salades" value="${requestScope['list_salades']}" />
...
<html>
    <head>
        ...
        <title>- Tendr'Epis - Salades -</title>
    ...
    <body>
        <table id="tableau_01" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <c:when test="${(user==null)}">
                                            <div id="conteneur" onmouseover="affiche('compte');" onmouseout="cache(event,'compte');" class="conteneur_01">
                                                ...
                                                <div id="compte">                                        
                                                    ...
                                                    <input type="text" name="page_name" class="hidden_txtbox_id_produit" value="salades_list" />
            ...
            <tr>
                <td class="contenu">
                    <a href="index.jsp" class="contenu_lien">Accueil</a> > <a href="salades_list" class="contenu_lien">Salades</a>
                </td>                
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <table cellpadding="0" cellspacing="0" align="center">
                            ...
                            <c:forEach var="p" items="${list_salades}">
                                <tr>
                                    <td class="cell_text">
