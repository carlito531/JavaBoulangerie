...
<c:set var="error_checkbox_salade" value="${requestScope['error_checkbox_salade']}" />
<c:set var="list_ingredients_salade" value="${requestScope['list_ingredients_salade']}" />
...
<c:set var="error_checkbox_fruit" value="${requestScope['error_checkbox_fruit']}" />
<c:set var="list_ingredients_fruit" value="${requestScope['list_ingredients_fruit']}" />
<c:set var="error_checkbox_extra" value="${requestScope['error_checkbox_extra']}" />
<c:set var="list_ingredients_extra" value="${requestScope['list_ingredients_extra']}" />
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>- Tendr'Epis - Salades Personnalisées -</title>
    ...
    <body onload="uncheckedRadioButton()">
        <table id="tableau_01" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <c:when test="${(user==null)}">
                                            <div id="conteneur" onmouseover="affiche('compte');" onmouseout="cache(event,'compte');" class="conteneur_01">
                                                ...
                                                <div id="compte">                                        
                                                    ...
                                                    <input type="text" name="page_name" class="hidden_txtbox_id_produit" value="salades_perso_list" />
            ...
            <tr>
                <td class="contenu">
                    <a href="index.jsp" class="contenu_lien">Accueil</a> > <a href="salades_perso_list" class="contenu_lien">Salades Personnalisées</a>
                </td>                
            </tr>
            <tr>
            ...
            <tr>
                <td class="titre_contenu_page">
                    CREEZ VOTRE SALADE PERSONNALISEE
                    <hr />
                </td>
            </tr>            
            <tr>
                <td>
                    <form id="form_ajout_ingredient" method="post" action="ajoutpaniersaladeperso"> 
                        <table id="tableau_ingredient" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                <td colspan="2" class="title_step">
                                    <input type="text" name="page_name" class="hidden_txtbox_id_produit" value="salades_perso_list" />
                                    1 : Choisissez la salade
                                    <hr />
                                </td>
                            </tr>
                            <c:choose>
                                <c:when test="${(error_checkbox_salade != null)}">
                                    <tr>
                                        <td colspan="2">
                                            <label name="error_cbox_salade" class="error">${error_checkbox_salade}</label>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <tr>
                                <td colspan="2" class="ingredient">
                                    <table id="tableau_salade" cellpadding="0" cellspacing="0" align="center">
                                        <tr>
                                        ...
                                        <c:forEach var="ing" items="${list_ingredients_salade}">
                                            <tr>
                                                <td class="tableau_ingredient_cell">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${(ing.stock > 0)}">                                                    
                                                            <input name="opt_salade" type="checkbox" value="opt_salade_${ing.identifiant}" onclick="optSelectedMaxOne(this);" />
                                                        </c:when>
                                                    </c:choose>
                                                </td>
                                                <td class="tableau_ingredient_cell">
                            ...
                            <tr>
                                <td colspan="2" class="title_step">
                                    <span class="title_step_opt">(Optionnel)</span> 6 : Choisissez un fruit <span class="title_step_ital">(Max. 2)</span>
                                    <hr />
                                </td>
                            </tr>
                            <c:choose>
                                <c:when test="${(error_checkbox_fruit != null)}">
                                    <tr>
                                        <td colspan="2">
                                            <label name="error_cbox_fruit" class="error">${error_checkbox_fruit}</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="interligne_02" colspan="2">                                            
                            ...
                            <tr>
                                <td colspan="2" class="ingredient">
                                    <table id="tableau_fruit" cellpadding="0" cellspacing="0" align="center">
                                        <tr>
                                            <td class="tableau_ingredient_header">
                                        ...
                                        <c:forEach var="ing" items="${list_ingredients_fruit}">
                                            <tr>
                                                <td class="tableau_ingredient_cell">
                                                    <c:choose>
                                                        <c:when test="${(ing.stock == 0)}">                                                                                       
                                                        ...
                                                        <c:when test="${(ing.stock > 0)}">                                                    
                                                            <input name="opt_fruit" type="checkbox" value="opt_fruit_${ing.identifiant}" onclick="optSelectedMaxTwo(this);" />
                                                        </c:when>
                                                    </c:choose>
                                                </td>
                                                <td class="tableau_ingredient_cell">
                                                ...
                                                <td class="tableau_ingredient_cell">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${(ing.stock > 0)}">                                                    
                                                            <input id="my_qte_opt_fruit_${ing.identifiant}" name="qte_opt_fruit_${ing.identifiant}" type="text" value="1" class="qte_ingredient" maxlength="1" onkeyup="CheckQteIngredient(this);" />                           
                                                        </c:when>
                                                    </c:choose>
                                                </td>  
                                            </tr>
                            ...
                            <tr>
                                <td colspan="2" class="title_step">
                                    <span class="title_step_opt">(Optionnel)</span> 7 : Choisissez un extra <span class="title_step_ital">(Max. 2)</span>
                                    <hr />
                                </td>
                            </tr>
                            <c:choose>
                                <c:when test="${(error_checkbox_extra != null)}">
                                    <tr>
                                        <td colspan="2">
                                            <label name="error_cbox_extra" class="error">${error_checkbox_extra}</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="interligne_02" colspan="2">                                            
                            ...
                            <tr>
                                <td colspan="2" class="ingredient">
                                    <table id="tableau_extra" cellpadding="0" cellspacing="0" align="center">
                                        <tr>
                                            <td class="tableau_ingredient_header">
                                        ...
                                        <c:forEach var="ing" items="${list_ingredients_extra}">
                                            <tr>
                                                <td class="tableau_ingredient_cell">
                                                    <c:choose>
                                                        <c:when test="${(ing.stock == 0)}">                                                                                       
                                                        ...
                                                        <c:when test="${(ing.stock > 0)}">                                                    
                                                            <input name="opt_extra" type="checkbox" value="opt_extra_${ing.identifiant}" onclick="optSelectedMaxTwo(this);" />
                                                        </c:when>
                                                    </c:choose>
                                                </td>
                                                <td class="tableau_ingredient_cell">
                                                ...
                                                <td class="tableau_ingredient_cell">
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${(ing.stock > 0)}">                                                    
                                                            <input id="my_qte_opt_extra_${ing.identifiant}" name="qte_opt_extra_${ing.identifiant}" type="text" value="1" class="qte_ingredient" maxlength="1" onkeyup="CheckQteIngredient(this);" />                           
                                                        </c:when>
                                                    </c:choose>
                                                </td>  
                                            </tr>
                                    ...
                                    <table id="tableau_button" cellspacing="0" cellpadding="0" align="right">
                                        <tr>
                                            ...
                                            <td class="button_on_left">
                                                <input type="submit" name="addSalade" value="AJOUTER MA SALADE AU PANIER" class="button_ajouter" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
