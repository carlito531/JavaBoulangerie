...
<c:set var="list_sandwichs" value="${requestScope['list_sandwichs']}" />
...
<html>
    <head>
        ...
        <title>- Tendr'Epis - Sandwichs -</title>
    ...
    <body>
        <table id="tableau_01" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <c:when test="${(user==null)}">
                                            <div id="conteneur" onmouseover="affiche('compte');" onmouseout="cache(event,'compte');" class="conteneur_01">
                                                ...
                                                <div id="compte">                                        
                                                    ...
                                                    <input type="text" name="page_name" class="hidden_txtbox_id_produit" value="sandwichs_list" />
            ...
            <tr>
                <td class="contenu">
                    <a href="index.jsp" class="contenu_lien">Accueil</a> > <a href="sandwichs_list" class="contenu_lien">Sandwichs</a>
                </td>                
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <table cellpadding="0" cellspacing="0" align="center">
                            ...
                            <c:forEach var="p" items="${list_sandwichs}">
                                <tr>
                                    <td class="cell_text">
