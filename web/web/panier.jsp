...
<c:set var="list_prod_panier" value="${requestScope['list_prod_panier']}" />
<c:set var="errorQte" value="${requestScope['error_qte']}" />
<c:set var="commandeValide" value="${requestScope['commande_valide']}" />
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>- Tendr'Epis - Mon Panier -</title>
    ...
    <body>
        <table id="tableau_01" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <c:when test="${(user==null)}">
                                            <div id="conteneur" onmouseover="affiche('compte');" onmouseout="cache(event,'compte');" class="conteneur_01">
                                                ...
                                                <div id="compte">                                        
                                                    ...
                                                    <input type="text" name="page_name" class="hidden_txtbox_id_produit" value="consultepanier" />
            ...
            <tr>
                <td class="contenu">
                    <a href="index.jsp" class="contenu_lien">Accueil</a> > <a href="consultepanier" class="contenu_lien">Mon Panier</a>
                </td>                
            </tr>
            <tr>
            ...
            <c:choose>
                <c:when test="${((panier == null) && (commandeValide == null))}">
                    <tr>
                        <td class="error_panier_vide">
                            <label name="error_panier">Votre panier est vide !</label>
                        </td>
                    </tr>
                    <tr>
                        <td class="interligne_02">                                            
            ...
            <c:choose>
                <c:when test="${(errorQte != null)}">
                     <tr>
                        <td class="error_panier_vide">
                            <label name="lbl_erreur_qte" class="erreur_quantite">${errorQte}</label>
                        </td>
                    </tr>
                    <tr>
                        <td class="interligne_02">                                            
            ...
            <c:choose>
                <c:when test="${(panier != null)}">
                    <tr>
                        <td>
                            <table id="tableau_panier" cellpadding="0" cellspacing="0" align="center">
                                <tr>
                                    <td>
                                ...
                                <c:forEach var="p" items="${list_prod_panier}" varStatus="status">
                                    <tr>
                                        <td class="cell_img">
                                        ...
                                        <td class="cell_text_top">
                                            <form id="form_maj_panier" method="post" action="majpanier">
                                                <input type="text" name="index_list_product" class="hidden_txtbox_id_produit" value="${status.index}" />
                                                <input type="text" name="page_name" class="hidden_txtbox_id_produit" value="consultepanier" />
                                                <input type="text" name="id_produit" class="hidden_txtbox_id_produit" value="${p.article.identifiant}" />
                                                <input type="submit" name="reduire_qte" class="button_moins" value="-" />
                                                <input type="text" name="quantite_produit" value="${p.quantiteArticle}" class="qte_produit" maxlength="2" readOnly="true"/>
                                                <input type="submit" name="augmenter_qte" class="button_plus" value="+" />
                                                <br />
                                                <input type="submit" name="supp_prod" class="button_supp" value="SUPPRIMER" />
                                            </form>
                                        </td>
                                        <td class="cell_text_top_bgc">
                                            ${p.totalPrixArticle}€
                                ...
                                <tr>
                                    <td colspan="5" align="right">                                       
                                        <form id="form_valider_commande" method="post" action="validercommande">
                                            <input type="text" name="page_name" class="hidden_txtbox_id_produit" value="consultepanier" />
                                            <input type="submit" name="valider_com" value="VALIDER MA COMMANDE" class="button_valider_commande" />
                                        </form>
                                    </td>
                                </tr>
                                <tr>
            ...
            <c:choose>
                <c:when test="${(commandeValide != null)}">
                     <tr>
                        <td class="commande_valide">
                            <label name="recap_commande">${commandeValide}</label>
                        </td>
                    </tr>
                    <tr>
                        <td class="interligne_02">                                            
