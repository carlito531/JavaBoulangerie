...
<c:set var="list_desserts" value="${requestScope['list_desserts']}" />
...
<html>
    <head>
        ...
        <title>- Tendr'Epis - Desserts -</title>
    ...
    <body>
        <table id="tableau_01" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <c:when test="${(user==null)}">
                                            <div id="conteneur" onmouseover="affiche('compte');" onmouseout="cache(event,'compte');" class="conteneur_01">
                                                ...
                                                <div id="compte">                                        
                                                    ...
                                                    <input type="text" name="page_name" class="hidden_txtbox_id_produit" value="desserts_list" />
            ...
            <tr>
                <td class="contenu">
                    <a href="index.jsp" class="contenu_lien">Accueil</a> > <a href="desserts_list" class="contenu_lien">Desserts</a>
                </td>                
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <table cellpadding="0" cellspacing="0" align="center">
                            ...
                            <c:forEach var="p" items="${list_desserts}">
                                <tr>
                                    <td class="cell_text">
