...
@WebServlet(name = "SandwichsPersoServlet", urlPatterns = {"/sandwichs_perso_list"})
public class SandwichsPersoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            CategorieProduit cat = daoCategorie.findCategorieByLibelle("Sandwichs Personnalisés");
            
            TypeIngredient typeIng = daoTypeIngredient.findTypeIngredientByLibelle("Pains");    
            request.setAttribute("list_ingredients_pain", daoIngredient.getListOfIngredientsByIdCategorieAndIdType(cat.getId(), typeIng.getIdentifiant()));
            typeIng = null;
            ...
            RequestDispatcher rd = request.getRequestDispatcher("sandwichs_perso.jsp");
